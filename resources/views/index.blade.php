...
<div class="row">
	...
	<div class="row pt-5">
        ...
        <form method="POST" id="prct" name ="prct" action="{{url('insert_entrant')}}" enctype="multipart/form-data" files='true' novalidate>
                      {{ csrf_field() }}
		      ...
		      <div class="form-group">
		          <div class="row">
		            ...
		            <div class="col-md-6">
		              ...
		              <div class="d-flex flex-column text-center {{ $errors->has('lastName') ? 'has-error' : '' }}">
                           <input class="control-label " id = "lastName" type="text" placeholder="lastName" name="lastName" required="required" value="{{old('lastName')}}">
		            ...
		            <div class="col-md-6">
		              ...
		              <div class="d-flex flex-column text-center {{ $errors->has('firstName') ? 'has-error' : '' }}">
                           <input class="control-label " id = "firstName" type="text" placeholder="firstName" name="firstName" required="required" value="{{old('firstName')}}">
                           <!--affichage du message "obligation de renseigner ce champs" -->
		      ...
		      <div class="form-group">
		          <div class="row">
		            <div class="col-md-6">
		              ...
		              <div class="d-flex flex-column text-center {{ $errors->has('email') ? 'has-error' : '' }}">
                           <input class="control-label " value="{{old('email')}}" id = "email" type="email" placeholder="example@yahoo.fr" name="email" required="required">
                           <!--affichage du message "obligation de renseigner ce champs" -->
		            ...
		            <div class="col-md-6">
		              ...
		              <div class="d-flex flex-column text-center {{ $errors->has('phone') ? 'has-error' : '' }} required">
                           <input class="control-label " value="{{old('phone')}}" id = "phone" type="text" placeholder="phone" name="phone" required="required">
                           <!--affichage du message "obligation de renseigner ce champs" -->
